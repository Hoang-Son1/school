...
function permissionnote1(){
    var x = document.getElementById("permissionnote1");
    if (x.style.display == "flex"){
        x.style.display = "none";
    } else{
        x.style.display = "flex";
...
function payment3(){
    var x = document.getElementById("payment3");
    if (x.style.display == "flex"){
        x.style.display = "none";
    } else{
        x.style.display = "flex";
...
function payment4(){
    var x = document.getElementById("payment4");
    if (x.style.display == "flex"){
        x.style.display = "none";
    } else{
        x.style.display = "flex";
...
function payment5(){
    var x = document.getElementById("payment5");
    if (x.style.display == "flex"){
        x.style.display = "none";
    } else{
        x.style.display = "flex";
...
function paymentmore(){
    var x = document.getElementById("paymentmore");
    if (x.style.display == "block"){
        x.style.display = "none";
    } else{
        x.style.display = "block";
